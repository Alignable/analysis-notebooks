...
### Pattern 1: Two-Way Match — You Each Fit What the Other Is Looking For (current rank 1)

**Scores**
- Why this person? 5/5 — Copy makes it crystal clear: both profiles explicitly match each other's stated criteria.
- Why this action? 4/5 — Implies high reply likelihood, making sending the message a no-brainer, though doesn't explicitly contrast with doing nothing.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 5/5 — "Two-way relationships tend to stick because nobody's doing all the giving" is concrete and compelling.

**Decision:** leave-as-is

---

### Pattern 2: Referral Partnership Fit (current rank 2)

**Scores**
- Why this person? 5/5 — "They listed your industry in their partner wishlist" — specific, profile-evidence-based.
- Why this action? 4/5 — "Before someone else does" adds competitive pressure to act; messaging is obviously the right step.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 5/5 — "A single referral partner who actually sends you leads on a regular basis can be worth more than dozens of loose connections" is vivid and concrete.

**Decision:** leave-as-is

---

### Pattern 3: Target Could Be a Direct Customer (current rank 3)

**Scores**
- Why this person? 4/5 — "Their role matches your ideal customer profile" is clear, though slightly less specific than patterns 1–2.
- Why this action? 3/5 — "A short intro could open a real opportunity" is vague — doesn't articulate why messaging now vs. waiting, or why messaging beats other approaches.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 4/5 — "One real customer relationship can pay for months of networking time" is good but hedged heavily ("doesn't guarantee a sale").

**Decision:** rewrite (strengthen "Why this action?" bullet)
...
- Starting a conversation beats waiting to be found

---

### Pattern 4: You Fit Their Ideal Customer Profile (current rank 4)

**Scores**
- Why this person? 5/5 — "This person described their ideal customer — and your business fits that description" is highly specific.
- Why this action? 4/5 — "Your message doesn't feel like a cold pitch; it feels like a welcome answer" explains why sending a message works here.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 4/5 — "You're much more likely to get a reply" is concrete; the flipped dynamic is compelling.

**Decision:** leave-as-is

---

### Pattern 5: Meeting Already in Progress — Keep the Momentum (current rank 5)

**Scores**
- Why this person? 4/5 — Specific because there's an existing meeting thread — clearly not random.
- Why this action? 5/5 — "The only thing standing between you and a real relationship is one more message" is perfectly clear.
- Why now? 5/5 — "People get busy and threads go cold; a timely nudge..." — genuine urgency, not manufactured.
- What's in it for me? 5/5 — "Don't lose the momentum you've already built" ties directly to sunk cost and forward motion.

**Decision:** leave-as-is

---

### Pattern 6: Conversation Already Active — Re-engage the Thread (current rank 6)

**Scores**
- Why this person? 4/5 — "This person already replied to you" clearly differentiates them from everyone else.
- Why this action? 5/5 — "A short follow-up message can restart something that was already going somewhere" — messaging is obviously the right tool.
- Why now? 4/5 — "Conversations stall all the time, not because of disinterest but because life gets in the way" implies gentle urgency without manufacturing it.
- What's in it for me? 4/5 — "You've already cleared the hardest hurdle (getting a reply)" is concrete.

**Decision:** leave-as-is

---

### Pattern 7: Introduced by a Mutual Contact (current rank 7)

**Scores**
- Why this person? 5/5 — "Someone you both trust thought you should meet" — the introduction is maximally specific.
- Why this action? 5/5 — "Ignoring a warm intro feels rude" — social obligation makes messaging the obvious move.
- Why now? 4/5 — "You were just introduced" implies recency; genuine time sensitivity.
- What's in it for me? 5/5 — "Your odds of a meaningful reply are significantly higher here" is concrete and believable.

**Decision:** leave-as-is

---

### Pattern 8: Target Serves Your Customers — They Could Refer You (current rank 8)

**Scores**
- Why this person? 4/5 — "This person works with the same kinds of clients you do — but offers different services" clearly identifies why *them*.
- Why this action? 3/5 — "Worth exploring how you complement each other" is weak — doesn't explain why messaging is the right action or what the message should accomplish.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 5/5 — "One relationship like this can become a steady, low-effort source of warm introductions" is vivid and specific.
...
- A message now starts the referral relationship

---

### Pattern 9: Same Local Area (current rank 9)

**Scores**
- Why this person? 4/5 — "They're just a short drive from your business" is clear and specific.
- Why this action? 3/5 — "Easy to meet in person if the fit is right" hints at a next step but doesn't explain why messaging on this platform vs. running into them naturally.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 4/5 — "Being connected to the businesses around you means you're top of mind when those referrals happen" is solid but slightly abstract.
...
- Local owners refer people they know and trust
- An intro message puts you on their radar first

---

### Pattern 10: Business Model & Geographic Reach Alignment (current rank 10)

**Scores**
- Why this person? 3/5 — "You're both focused on B2B clients" and "geographic reach overlaps" are structurally correct but generic — many people share these traits.
- Why this action? 3/5 — "That usually means shared referral opportunities" hedges with "usually" and doesn't compel action.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 3/5 — "This is the kind of connection that pays off without either of you having to force it" is vague — what specific benefit? Referrals? Knowledge? Vendor recommendations?

**Decision:** rewrite (strengthen all three weak lenses — make the specificity match the data)

**Rewritten copy:**
> *You and {target_first_name} sell to the same type of buyer nearby.*
- Same business model means shared prospects
- Overlapping geography means you'll hear about each other
- That's a natural setup for trading referrals

---

### Pattern 11: Mutual Connections (current rank 11)

**Scores**
- Why this person? 4/5 — "You and this person already move in the same circles" clearly specifies what makes them different.
- Why this action? 3/5 — "Common ground can fast-track a real conversation" — too abstract, doesn't explain why messaging beats waiting.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 3/5 — "People respond faster when they can see a familiar name in common" — the benefit is a faster reply, which is means-to-an-end, not an end in itself.

**Decision:** rewrite (strengthen WIIFM and "Why this action?")

**Rewritten copy:**
> *You and {target_first_name} already share connections here.*
- People you both trust are in each other's networks
- Mutual contacts make your name familiar instantly
- That familiarity means higher reply rates and faster trust

---

### Pattern 12: Same or Related Industry / Role Overlap (current rank 12)

**Scores**
- Why this person? 4/5 — "They already speak your language" is clear shorthand for same-industry relevance.
- Why this action? 3/5 — "Worth a conversation" is a filler phrase that doesn't make the case for action.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 4/5 — "Industry peers... send you overflow work, share vendor recommendations" is concrete and varied.

**Decision:** rewrite (fix the headline's weak call-to-action)

**Rewritten copy:**
> *{target_first_name} is in your industry — peers send overflow your way.*
- Same field means they get leads they can't serve
- They already understand your work without explanation
- Could become your go-to for joint projects

---

### Pattern 13: Known Outside the Platform (current rank 13)

**Scores**
- Why this person? 4/5 — "They showed up in your contacts" is specific and evidence-based.
- Why this action? 4/5 — "Re-connecting here could turn a dormant contact into an active business relationship" — clear rationale for messaging.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 3/5 — "People are far more likely to respond to a name they recognize" — the benefit is a reply, not a business outcome.

**Decision:** rewrite (strengthen WIIFM to point at the business payoff, not just the reply)
...
- Dormant contacts often turn into real business once re-activated

---

### Pattern 14: Met at a Networking Event (current rank 14)

**Scores**
- Why this person? 5/5 — "You were both in the same room recently" — extremely specific shared experience.
- Why this action? 4/5 — "Following up quickly after an event is what separates the people who build real networks from the people who collect business cards" — clear why messaging is the move.
- Why now? 5/5 — "They're more likely to remember you and respond while the event is still fresh" — genuine, non-manufactured urgency.
- What's in it for me? 4/5 — Implied benefit is a warmer response and relationship-building, though no explicit business outcome stated.

**Decision:** leave-as-is

---

### Pattern 15: Shared Community or Group Membership (current rank 15)

**Scores**
- Why this person? 3/5 — "You're both members of the same group" — many people could share a group; doesn't strongly differentiate *this* person.
- Why this action? 3/5 — "A natural, low-pressure way to start a conversation" — describes the tenor of the message but not why to send one.
- Why now? N/A — Evergreen — no time signal in the data.
- What's in it for me? 2/5 — "Think of it as being neighbors in the same digital neighborhood" — metaphor, not a benefit. No concrete payoff articulated.

**Decision:** rewrite (WIIFM is especially weak; "Why this person?" needs sharpening)

**Rewritten copy:**
> *You and {target_first_name} are in the same community — say hello.*
- Same group means they've opted into your world
- Members tend to respond to fellow members
- Group connections often turn into referral partners

---

### Pattern 16: Discussion Post Connection Origin (current rank 16)

**Scores**
- Why this person? 5/5 — "You connected over a specific post" — maximally personal and unique.
- Why this action? 4/5 — "Keep it going" and "pick up where you left off" make messaging the obvious next step.
- Why now? 4/5 — The connection is recent; context fades with time.
- What's in it for me? 3/5 — "People are more likely to engage when they remember *why* they connected" — the benefit is engagement, not a business outcome.

**Decision:** rewrite (strengthen WIIFM)

**Rewritten copy:**
> *{target_first_name}, you connected over a discussion — keep it going.*
- You both engaged with the same group post
- That shared interest makes your message stand out
- A timely follow-up can turn shared curiosity into real business

**Prune recommendation:** Despite the rewrite, overall availability is ~0.3%. However, when this pattern *does* fire, it's extremely personalized and high-intent. **Recommend retiring** — at 0.3% availability, the maintenance cost of carrying this pattern likely exceeds its value. Only 1 record in the dataset contains these fields. If event-driven patterns expand in the future, this could be revived.
...
- Overall availability: ~15.0% (bottlenecked by `sender_matches_recipient_partner_targets`; the two flags must co-occur, so real overlap is likely ~5–8%) ⚠️ low-coverage
...
**Rank rationale:** A confirmed bidirectional fit is the single most compelling reason to message someone — it removes the biggest fear ("will they even care?").
...
- Supplementary:
  ...
  - `state.prompt_context.input.recipient.profile_data.recipient_about_section.recipient_description` (76.8%)
- Overall availability: ~1.3% ⚠️ low-coverage
...
**Example**
> *You were just introduced to {target_first_name} — don't leave them waiting.*
...
**Rank rationale:** Warm introductions have the highest response rates of any outreach type — the social obligation to reply is powerful.
...
- Supplementary:
  ...
  - `state.prompt_context.input.recipient.profile_data.recipient_about_section.recipient_description` (76.8%)
- Overall availability: ~4.4% ⚠️ low-coverage
...
**Rank rationale:** Shared event attendance is a strong social proof signal with genuine time-sensitivity, but availability is very low.
...
- Supplementary:
  ...
  - `state.prompt_context.input.relationship_data.distance_miles` (99.7%)
  - `state.prompt_context.input.recipient.profile_data.recipient_about_section.recipient_description` (76.8%)
- Overall availability: ~7.2% ⚠️ low-coverage

**What's in it for me?**
You're both members of the same group — that's built-in common ground you didn't have to create. Community members tend to look out for each other and respond more warmly to fellow members than to strangers. Group connections are often the ones that turn into referral partners because the trust baseline is already higher.
...
**Rank rationale:** Common group is a trust signal but doesn't imply business fit — a useful secondary hook, not a primary motivator.

---

*Retired: **Discussion Post Connection Origin** (previously rank 16) — at 0.3% availability (1 record in dataset), the pattern cannot fire at meaningful scale. The signal is strong when present, but the cost of maintaining, testing, and explaining a pattern that applies to <1% of users outweighs its value. Recommend reviving if discussion-post connections grow materially.*